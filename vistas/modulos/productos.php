    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
          ...
          <a href="productos" class="btn btn-default pull-left">Cancelar</a>
           ...
           <div class="form-group row"> 
            ...
            <div class="col-xs-12 col-sm-6">
              ...
              <div class="input-group"> 
                  ...
                  <input type="text" class="form-control input-lg" id="editarPrecioCompra" id="editarPrecioCompra" name="editarPrecioCompra"  min="0" step="any" required>
